...
const Create = async () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center px-4">
      ...
      <div className="p-2 md:p-4 max-w-2xl w-full rounded-md border border-white/15 shadow-pink-500 shadow-sm">
        <Textarea
        ...
        <div className="flex items-center justify-end mt-4">
          <Button className="cursor-pointer bg-neutral-800 hover:bg-neutral-900 text-white text-xs sm:text-sm">
            Create
