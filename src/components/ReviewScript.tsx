...
const ReviewScript = ({
  ...
  return (
    <div className="h-screen bg-[radial-gradient(ellipse_90%_90%_at_50%_-30%,rgba(236,72,153,0.25),rgba(96,130,246,0.25),rgba(255,255,255,0))] flex bg-neutral-950/95 relative overflow-hidden text-white">
              ...
              return (
                ...
                >
                  {message.role === "assistant" ? (
                    <RiRobot2Fill className="size-4 text-blue-300 mb-2" />
                  ) : (
                    <FaUser className="size-4 text-pink-300 mb-2" />
                  )}
                  <div
                    className={`shadow-lg border border-neutral-800 flex-1 bg-neutral-900 p-4 rounded-md`}
                  >
      ...
      <section className="w-full overflow-hidden p-6 flex flex-col">
        ...
        <Textarea
          ...
          className="flex-1 overflow-y-auto bg-neutral-900/60 backdrop-blur-sm rounded-md border border-neutral-600 shadow-lg text-white p-4"
          style={{ resize: "none" }}
        />
        <Button className="py-6 cursor-pointer font-medium bg-neutral-800 border border-transparent hover:border-pink-300 text-pink-300 text-sm transition-all duration-200 ease-in-out mt-4">
